...
class ZeroDCEQ(py_nndct.nn.NndctQuantModel):
    def __init__(self):
        ...
        self.module_0 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1541
        self.module_1 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1547
        self.module_2 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1551
        self.module_3 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1555
        self.module_4 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1559
        self.module_5 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1563
        self.module_6 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1567
        self.module_7 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1571
        self.module_8 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1575
        self.module_9 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1543
        self.module_10 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1549
        self.module_11 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1553
        self.module_12 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1557
        self.module_13 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1561
        self.module_14 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1565
        self.module_15 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1569
        self.module_16 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1573
        self.module_17 = py_nndct.nn.Module('nndct_const') #ZeroDCEQ::1545
        ...
        self.module_31 = py_nndct.nn.ReLU(inplace=True) #ZeroDCEQ::ZeroDCEQ/ReLU[relu]/1226
        ...
        self.module_35 = py_nndct.nn.ReLU(inplace=True) #ZeroDCEQ::ZeroDCEQ/ReLU[relu]/1268
        ...
        self.module_39 = py_nndct.nn.ReLU(inplace=True) #ZeroDCEQ::ZeroDCEQ/ReLU[relu]/1310
        ...
        self.module_42 = py_nndct.nn.Conv2d(in_channels=64, out_channels=3, kernel_size=[1, 1], stride=[1, 1], padding=[0, 0], dilation=[1, 1], groups=1, bias=True) #ZeroDCEQ::ZeroDCEQ/CSDN_Tem[e_conv7]/Conv2d[point_conv]/1351
        self.module_43 = py_nndct.nn.Hardsigmoid(inplace=False) #ZeroDCEQ::ZeroDCEQ/1352
        self.module_44 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1542
        ...
        self.module_47 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1546
        self.module_48 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1467
        self.module_49 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1548
        self.module_50 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1371
        self.module_51 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1468
        self.module_52 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1375
        self.module_53 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1550
        self.module_54 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1469
        self.module_55 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1552
        self.module_56 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1384
        self.module_57 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1470
        self.module_58 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1388
        self.module_59 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1554
        self.module_60 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1471
        self.module_61 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1556
        self.module_62 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1397
        self.module_63 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1472
        self.module_64 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1401
        self.module_65 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1558
        self.module_66 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1473
        self.module_67 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1560
        self.module_68 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1410
        self.module_69 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1474
        self.module_70 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1414
        self.module_71 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1562
        self.module_72 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1475
        self.module_73 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1564
        self.module_74 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1423
        self.module_75 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1476
        self.module_76 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1427
        self.module_77 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1566
        self.module_78 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1477
        self.module_79 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1568
        self.module_80 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1436
        self.module_81 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1478
        self.module_82 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1440
        self.module_83 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1570
        self.module_84 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1479
        self.module_85 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1572
        self.module_86 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1449
        self.module_87 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1480
        self.module_88 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1453
        self.module_89 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1574
        self.module_90 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1481
        self.module_91 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::ZeroDCEQ/1576
        self.module_92 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1462
        self.module_93 = py_nndct.nn.Module('nndct_elemwise_mul') #ZeroDCEQ::1482
        self.module_94 = py_nndct.nn.Add() #ZeroDCEQ::ZeroDCEQ/1466
    ...
    def forward(self, *args):
        ...
        output_module_10 = self.module_10(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_11 = self.module_11(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_12 = self.module_12(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_13 = self.module_13(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_14 = self.module_14(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_15 = self.module_15(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_16 = self.module_16(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_17 = self.module_17(data=9.99999993922529e-09, dtype=torch.float, device='cpu')
        output_module_18 = self.module_18(input=args[0])
        output_module_19 = self.module_19(input=output_module_18, size=None, scale_factor=[0.25,0.25], mode='nearest')
        ...
        output_module_40 = self.module_46(input=output_module_40, size=None, scale_factor=[4.0,4.0], mode='nearest')
