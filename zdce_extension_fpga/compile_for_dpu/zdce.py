...
class ZeroDCEQ(zmod.enhance_net_nopool):
    def __init__(self, scale_factor=4, iterations=8):
...
def main():
    ...
    parser.add_argument("--model_path",  default='Epoch199.pth' ,
    ...
    net = ZeroDCEQ(scale_factor=4, iterations=args.iterations).to(device)
